#ifndef GE_DUMMYCOLLECTORPARTICLE_H_INCLUDED
#define GE_DUMMYCOLLECTORPARTICLE_H_INCLUDED

class GE_DLLIMPORT gCDummyCollectorParticle :
    public gCDummyCollectorPSet_Base
{
    ...
    public:    virtual                  ~gCDummyCollectorParticle( void );
    ...
    public:
        gCDummyCollectorParticle( eCEntity & );
        gCDummyCollectorParticle( gCDummyCollectorParticle const & );

    public:
        gCDummyCollectorParticle & operator = ( gCDummyCollectorParticle const & );
