#ifndef GE_DUMMYCOLLECTORENCLAVE_H_INCLUDED
#define GE_DUMMYCOLLECTORENCLAVE_H_INCLUDED

class GE_DLLIMPORT gCDummyCollectorEnclave :
    public gCDummyCollectorPSet_Base
{
    ...
    public:    virtual                  ~gCDummyCollectorEnclave( void );
    ...
    public:
        gCDummyCollectorEnclave( eCEntity & );
        gCDummyCollectorEnclave( gCDummyCollectorEnclave const & );

    public:
        gCDummyCollectorEnclave & operator = ( gCDummyCollectorEnclave const & );
