#ifndef GE_HELPER_H_INCLUDED
#define GE_HELPER_H_INCLUDED
...
GE_DLLIMPORT_EXTC GEInt GE_CCALL GE_MESSAGEF_INFO( GEInt, GELPChar, ... );
GE_DLLIMPORT_EXTC GEInt GE_CCALL GE_MESSAGEF_D_INFO( GEInt, GELPChar, ... );
GE_DLLIMPORT_EXTC GEInt GE_CCALL GE_MESSAGEF_OK( GELPChar, ... );
GE_DLLIMPORT_EXTC GEInt GE_CCALL GE_MESSAGEF_D_OK( GELPChar, ... );
GE_DLLIMPORT_EXTC GEInt GE_CCALL GE_MESSAGEF_WARN( GELPChar, ... );
GE_DLLIMPORT_EXTC GEInt GE_CCALL GE_MESSAGEF_D_WARN( GELPChar, ... );
GE_DLLIMPORT_EXTC GEInt GE_CCALL GE_MESSAGEF_LOGFILE( GELPChar, ... );
