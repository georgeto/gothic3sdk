...
GEU32 bTPropertyType<OBJECTCLASS, CLASS>::GetMemberOffset(void) const
{
    return this->m_u32MemberOffset;
}

template< typename OBJECTCLASS, typename CLASS >
GEU32 bTPropertyType<OBJECTCLASS, CLASS>::GetDataSize(void) const
{
    return sizeof(CLASS);
}

template< typename OBJECTCLASS, typename CLASS >
bCString const & bTPropertyType<OBJECTCLASS, CLASS>::GetObjectTypeClassName(void) const
{
    return this->m_pPropertyObjectType->GetClassName();
}

template< typename OBJECTCLASS, typename CLASS >
bCString const & bTPropertyType<OBJECTCLASS, CLASS>::GetPropertyClassName(void) const
{
    return bTClassName<CLASS>::GetUnmangled();
}

template< typename OBJECTCLASS, typename CLASS >
bCPropertyObjectTypeBase const * bTPropertyType<OBJECTCLASS, CLASS>::GetObjectType(void) const
{
...
template< typename OBJECTCLASS, typename CLASS >
GEBool bTPropertyType<OBJECTCLASS, CLASS>::HasEnumValues(void) const
{
...
{
    return a_pPropertyObject ? this->m_u32MemberOffset + reinterpret_cast<GELPCByte>(a_pPropertyObject->GetObject()) : 0;
}
...
template< typename OBJECTCLASS, typename CLASS >
GEBool bTPropertyType<OBJECTCLASS, CLASS>::PropertyCopy(bCPropertyObjectBase * a_pDestPropertyObject, bCPropertyObjectBase const * a_pSource)
{
...
template< typename OBJECTCLASS, typename CLASS >
void bTPropertyType<OBJECTCLASS, CLASS>::PropertyDeprecate(bCIStream & a_InStream, bCPropertyObjectBase & a_pPropertyObject, bCString const & a_strUnk1, bCString const & a_strUnk2, GEBool a_bNotify)
{
    this->Read(a_InStream);
    GEU32 u32Size;
    a_InStream >> u32Size;
...
template< typename OBJECTCLASS, typename CLASS >
void bTPropertyType<OBJECTCLASS, CLASS>::Destroy(void)
{
...
template< typename OBJECTCLASS, typename CLASS >
void bTPropertyType<OBJECTCLASS, CLASS>::Create(void)
{
...
template< typename OBJECTCLASS, typename CLASS >
bCPropertyTypeBase * bTPropertyType<OBJECTCLASS, CLASS>::DoClone(void) const
{
...
template< typename OBJECTCLASS, typename CLASS >
bTPropertyType<OBJECTCLASS, CLASS>::~bTPropertyType(void)
{
    this->Destroy();
}
...
{
    if(!a_pPropertyObject)
        GE_FATAL_ERROR_EX(__FUNCDNAME__" - Propertyobject is NULL, can¦t get propertyvalue from NULLobject ! ", "GEFalse == (NULL != a_pPropertyObject)")
...
{
    if(!a_pPropertyObject)
        GE_FATAL_ERROR_EX(__FUNCDNAME__" - Propertyobject is NULL, can¦t access propertyvalue from NULobject ! ", "GEFalse == (NULL != a_pPropertyObject)")

    return reinterpret_cast<CLASS *>(PropertyAccess(a_pPropertyObject));
}

template< typename OBJECTCLASS, typename CLASS >
bTPropertyType<OBJECTCLASS, CLASS>::bTPropertyType(bCPropertyObjectTypeBase & a_pPropertyObjectType, GEU32 a_u32MemberOffset, bCString const & a_strPropertyName, bCString const & a_strPropertyCategory, bCString const & a_strPropertyDescription, bEPropertyType a_enuPropertyType, GEBool a_bReadOnly)
    : bTPropertyTypeOnly<CLASS>(a_strPropertyName, a_strPropertyCategory, a_strPropertyDescription, a_enuPropertyType, a_bReadOnly), m_pPropertyObjectType(&a_pPropertyObjectType), m_u32MemberOffset(a_u32MemberOffset), m_pArrEnumWrappers(0)
{
    Create();
}

template< typename OBJECTCLASS, typename CLASS >
bTPropertyType<OBJECTCLASS, CLASS>::bTPropertyType(bCPropertyObjectTypeBase & a_pPropertyObjectType, GEU32 a_u32MemberOffset, bCString const & a_strPropertyName, bCString const & a_strPropertyCategory, bEPropertyType a_enuPropertyType, GEBool a_bReadOnly)
: bTPropertyTypeOnly<CLASS>(a_strPropertyName, a_strPropertyCategory, a_enuPropertyType, a_bReadOnly), m_pPropertyObjectType(&a_pPropertyObjectType), m_u32MemberOffset(a_u32MemberOffset), m_pArrEnumWrappers(0)
{
    Create();
}

template< typename OBJECTCLASS, typename CLASS >
bTPropertyType<OBJECTCLASS, CLASS>::bTPropertyType(bCPropertyObjectTypeBase & a_pPropertyObjectType, GEU32 a_u32MemberOffset, bCString const & a_strPropertyName, bEPropertyType a_enuPropertyType)
: bTPropertyTypeOnly<CLASS>(a_strPropertyName, a_enuPropertyType), m_pPropertyObjectType(&a_pPropertyObjectType), m_u32MemberOffset(a_u32MemberOffset), m_pArrEnumWrappers(0)
{
    Create();
}
...
bTPropertyObject<CLASS, BASECLASS>::bTPropertyObject(void)
{
