...
template< typename T >
T * bTSmallArray< T >::AccessArray( void )
{
...
template< typename T >
void bTSmallArray< T >::Clear( void )
{
    if( this->m_pArray )
...
template< typename T >
T const * bTSmallArray< T >::GetArray( void ) const
{
    return this->m_pArray;
}
...
template< typename T >
GEU16 bTSmallArray< T >::GetCapacity( void ) const
{
    return static_cast< GEU16 >( this->m_u16Capacity );
}

template< typename T >
GEU16 bTSmallArray< T >::GetCount( void ) const
{
...
template< typename T >
GEBool bTSmallArray< T >::IsEmpty( void ) const
{
...
template< typename T >
void bTSmallArray< T >::RemoveAll( void )
{
    this->Clear();
}
...
void bTSmallArray< T >::Reserve( GEU16 _n )
{
    if( _n > this->GetCapacity() )
    {
        ...
        //g_ZeroMemory( this->m_pArray + this->GetCapacity(), sizeof( T ) * static_cast< GEU16 >( _n - this->GetCapacity() ) );
...
template< typename T >
bTSmallArray< T >::bTSmallArray( void )
{
    this->Init();
}
