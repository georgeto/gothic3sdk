...
class mTPropertyComparator : public mCPropertyComparator
{
  public:
...
#define SPECIALIZE_COMPARATOR(TYPE, OP, EXP)                                                                           \
    ...
    GE_STATIC_BLOCK                                                                                                    \
    {                                                                                                                  \
        s_Comparators[bTClassName<TYPE>::GetUnmangled()].SetAt(OP, GE_NEW((mTPropertyComparator<TYPE, OP>)));          \
    }
...
mCPropertyComparator *mCPropertyComparator::FindComparator(bCPropertyTypeBase *a_Property,
                                                           mEPropertyCompareOperator a_Operator)
{
...
GEBool mCPropertyComparator::Compare(bCPropertyTypeBase *a_Property, bCPropertyObjectBase const *a_pObject1,
