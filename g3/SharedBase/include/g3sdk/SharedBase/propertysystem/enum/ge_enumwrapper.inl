#include <SharedBase/kernel/message/ge_message.h>
...
bCString const &bTEnumWrapper<ENUMCLASS>::GetValueString() const
{
    ...
    if (Result.IsEmpty())
    {
        GE_IMPROPER_USAGE("Value of enumeration not found in translation map; written archive may not stay compatible "
...
template <typename ENUMCLASS>
bTEnumWrapper<ENUMCLASS>::~bTEnumWrapper()
{}
