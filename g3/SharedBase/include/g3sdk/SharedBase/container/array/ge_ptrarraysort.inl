...
bTPtrArraySort<T>::bTPtrArraySort(bTPtrArraySort<T> const &_s)
    : bTPtrArray<T>(_s), m_fComparator(_s.m_fComparator), m_bSorted(_s.m_bSorted)
{}

template <typename T>
bTPtrArraySort<T>::bTPtrArraySort(GEInt _n, gFCompare _fComparator)
    : bTPtrArray<T>(_n), m_fComparator(_fComparator), m_bSorted(GETrue)
{}

template <typename T>
bTPtrArraySort<T>::bTPtrArraySort(gFCompare _fComparator)
    : bTPtrArray<T>(), m_fComparator(_fComparator), m_bSorted(GETrue)
{}

template <typename T>
bTPtrArraySort<T>::~bTPtrArraySort()
{}
