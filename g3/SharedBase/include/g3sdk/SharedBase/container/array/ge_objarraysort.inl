...
bTObjArraySort<T>::bTObjArraySort(bTObjArraySort<T> const &_s)
    : bTObjArray<T>(_s), m_fComparator(_s.m_fComparator), m_bSorted(_s.m_bSorted)
{}

template <typename T>
bTObjArraySort<T>::bTObjArraySort(GEInt _n)
    : bTObjArray<T>(_n), m_fComparator(&g_ArraySortDefaultCompare), m_bSorted(GETrue)
{}

template <typename T>
bTObjArraySort<T>::bTObjArraySort() : bTObjArray<T>(), m_fComparator(&g_ArraySortDefaultCompare), m_bSorted(GETrue)
{}

template <typename T>
bTObjArraySort<T>::~bTObjArraySort()
{}
