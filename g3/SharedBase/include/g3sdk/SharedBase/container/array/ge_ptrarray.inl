...
template <typename T>
bTPtrArray<T>::bTPtrArray(bTPtrArray<T> const &_s) : bTValArray<T>(_s)
{}

template <typename T>
bTPtrArray<T>::bTPtrArray(GEInt _n) : bTValArray<T>(_n)
{}

template <typename T>
bTPtrArray<T>::bTPtrArray() : bTValArray<T>()
{}
