...
using D3DPOOL = enum _D3DPOOL;
using D3DPRIMITIVETYPE = enum _D3DPRIMITIVETYPE;

using D3DXHANDLE = LPCSTR;
using D3DXREGISTER_SET = enum _D3DXREGISTER_SET;
using D3DXPARAMETER_CLASS = enum _D3DXPARAMETER_CLASS;
using D3DXPARAMETER_TYPE = enum _D3DXPARAMETER_TYPE;
...
class GE_DLLIMPORT eCGfxShared
{
  public:
    ...
    {
        GE_UNIMPL_STRUCT(eSGfxEffectDesc)
    };

    struct eSGfxParameterDesc
    {
        GE_UNIMPL_STRUCT(eSGfxParameterDesc)
    };

    struct eSGfxTechniqueDesc
    {
        GE_UNIMPL_STRUCT(eSGfxTechniqueDesc)
    };
    ...
    struct eSGfxEffectMacro
    {
        GE_UNIMPL_STRUCT(eSGfxEffectMacro)
    };
    ...
    enum eEMasterRenderMode
    {
        eEMasterRenderMode_NoMaster = 0,
        // inherit all from eERenderMode
    };
    ...
    enum eEMasterShadeMode
    {
        eEMasterShadeMode_NoMaster = 0,
        // inherit all from eEShadeMode
    };
    ...
    enum eEMasterCullingMode
    {
        eEMasterCullingMode_NoMaster = 0,
        // inherit all from eECullingMode
    };
    ...
    enum eEMasterStencil
    {
        eEMasterStencil_NoMaster = 0,
        // inherit all from eEStencil
    };
    ...
    enum eEMasterBlending
    {
        eEMasterBlending_NoMaster = 0,
        // inherit all from eEBlending
    };
    ...
    enum eEMasterAlphaTest
    {
        eEMasterAlphaTest_NoMaster = 0
        // inherit all from eEAlphaTest
    };
    ...
    {
        GE_UNIMPL_STRUCT(eSGfxLightData)
    };

    struct eSGfxFogData
    {
        GE_UNIMPL_STRUCT(eSGfxFogData)
    };
    ...
    {
        GE_UNIMPL_STRUCT(eSGfxPlaneData)
    };

    struct eSGfxAssistantMethods
    {
        GE_UNIMPL_STRUCT(eSGfxAssistantMethods)
    };

    struct eSGfxAttributeWeigths
    {
        GE_UNIMPL_STRUCT(eSGfxAttributeWeigths)
    };

    struct eSGfxBoxData
    {
        GE_UNIMPL_STRUCT(eSGfxBoxData)
    };

    struct eSGfxCylinderData
    {
        GE_UNIMPL_STRUCT(eSGfxCylinderData)
    };

    struct eSGfxPolygonData
    {
        GE_UNIMPL_STRUCT(eSGfxPolygonData)
    };

    struct eSGfxSphereData
    {
        GE_UNIMPL_STRUCT(eSGfxSphereData)
    };

    struct eSGfxTextData
    {
        GE_UNIMPL_STRUCT(eSGfxTextData)
    };

    struct eSGfxTorusData
    {
        GE_UNIMPL_STRUCT(eSGfxTorusData)
    };

    struct eSGfxGaugeValues
    {
        GE_UNIMPL_STRUCT(eSGfxGaugeValues)
    };
    ...
    {
        GE_UNIMPL_STRUCT(eSTLTexVertex)
    };
    struct eSTLTexDiffuseVertex
    {
        GE_UNIMPL_STRUCT(eSTLTexDiffuseVertex)
    };
    struct eSTLColVertex
    {
        GE_UNIMPL_STRUCT(eSTLColVertex)
    };
    struct eSTexVertex
    {
        GE_UNIMPL_STRUCT(eSTexVertex)
    };

    enum eEAuxBufferType;
    enum eEColorFormat;
    enum eEContextCreate;
    enum eEGaugeModus;
    enum eEITLOptimization;
    enum eEMultiSample;
    enum eEPoolType;
};
