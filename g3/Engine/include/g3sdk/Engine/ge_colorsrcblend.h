...
class GE_DLLIMPORT eCColorSrcBlend : public eCColorSrcBase
{
    // clang-format off
    ...
    public: ~eCColorSrcBlend() override;
  ...
  public:
    GE_PROPERTY_SET(eCColorSrcBlend, eCColorSrcBase)

  public:
    eCColorSrcProxy &GetBlendSrc();
...
GE_ASSERT_SIZEOF(eCColorSrcBlend, 0xa4)
