...
class GE_DLLIMPORT eCMessageHandler : public bCObjectRefBase
{
    // clang-format off
    public: virtual HWND GetWindowHandle();
    public: virtual void SetWindowHandle(HWND);
    public: virtual void Idle();
    public: virtual GEInt LoopMessages();
    public: virtual GEInt ProcessNextMessage();
    public: virtual void ProcessNextMessage(tagMSG &, GEBool &, GEBool &, GEBool);
    public: virtual GEInt HandleMessage(HWND, GEUInt, GEUInt, GEI32);
    ...
    public: ~eCMessageHandler() override;
    // clang-format on
  ...
  public:
    GEBool m_IsEnabled;
    GEBool m_IsIdle;
    GEBool m_IsRedirected;
    GEBool m_IsTerminated;
    HWND m_WindowHandle;
};

GE_ASSERT_SIZEOF(eCMessageHandler, 0x14)
