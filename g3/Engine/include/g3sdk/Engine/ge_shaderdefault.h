...
class GE_DLLIMPORT eCShaderDefault : public eCShaderBase
{
    // clang-format off
    ...
    public: ~eCShaderDefault() override;
  ...
  public:
    GE_PROPERTY_SET(eCShaderDefault, eCShaderBase)
...
GE_ASSERT_SIZEOF(eCShaderDefault, 0x224)

GE_ASSERT_PROPERTY(eCShaderDefault, m_eTransformationType, 0xc0, 8)
GE_ASSERT_PROPERTY(eCShaderDefault, m_bEnableSpecular, 0xc8, 1)
GE_ASSERT_PROPERTY(eCShaderDefault, m_bDisableLighting, 0xc9, 1)
