...
class GE_DLLIMPORT eCGfxMixerAdmin : public bCObjectRefBase
{
    // clang-format off
    ...
    protected: ~eCGfxMixerAdmin() override;
    // clang-format on
  ...
  public:
    ...
    bEResult DrawCone(bCVector const &, GEFloat, GEFloat, bCVector const &, GEU32, bCMatrix const &, GEBool, GEBool,
                      GEBool);
    bEResult DrawCylinder(bCVector const &, GEFloat, GEFloat, GEFloat, bCVector const &, GEU32, bCMatrix const &,
                          GEBool, GEBool, GEBool);
    ...
    bEResult DrawTorus(bCVector const &, GEFloat, GEFloat, bCVector const &, GEU32, bCMatrix const &, GEBool, GEBool,
                       GEBool);
    ...
    bEResult EndScene() const;
    bEResult EndSpriteList() const;
    bEResult FlushSpriteList() const;
    ...
    GEU32 GetDrawnVisualIndices() const;
    GEU32 GetDrawnVisualVertices() const;
    ...
    bEResult SwapScreen(HWND const, bCRect const *, bCRect const *);

  protected:
    static GEBool ms_bOptimize;
    static void(GE_STDCALL *ms_pRegisterScreenSwapCall)();
    static void(GE_STDCALL *ms_pRegisterViewportClearCall)();
  ...
  protected:
    ...
    static void GE_STDCALL sSetScreenSwapCallback(void(GE_STDCALL *)());
    static void GE_STDCALL sSetViewportClearCallback(void(GE_STDCALL *)());

  protected:
    eCGfxMixerAdmin();

  protected:
    bEResult UpdateGammaRamp();
};
