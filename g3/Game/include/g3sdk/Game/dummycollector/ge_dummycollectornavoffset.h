...
class GE_DLLIMPORT gCDummyCollectorNavOffset : public gCDummyCollectorPSet_Base
{
    // clang-format off
    ...
    public: ~gCDummyCollectorNavOffset() override;
  ...
  public:
    explicit gCDummyCollectorNavOffset(eCEntity &);
