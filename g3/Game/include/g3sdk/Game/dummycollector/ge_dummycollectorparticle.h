...
class GE_DLLIMPORT gCDummyCollectorParticle : public gCDummyCollectorPSet_Base
{
    // clang-format off
    ...
    public: ~gCDummyCollectorParticle() override;
  ...
  public:
    explicit gCDummyCollectorParticle(eCEntity &);
