...
class GE_DLLIMPORT gCDummyCollectorCollisionCircle : public gCDummyCollectorPSet_Base
{
    // clang-format off
    ...
    public: ~gCDummyCollectorCollisionCircle() override;
  ...
  public:
    explicit gCDummyCollectorCollisionCircle(eCEntity &);
