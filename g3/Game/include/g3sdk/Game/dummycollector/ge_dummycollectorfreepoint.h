...
class GE_DLLIMPORT gCDummyCollectorFreepoint : public gCDummyCollectorPSet_Base
{
    // clang-format off
    ...
    public: ~gCDummyCollectorFreepoint() override;
  ...
  public:
    explicit gCDummyCollectorFreepoint(eCEntity &);
