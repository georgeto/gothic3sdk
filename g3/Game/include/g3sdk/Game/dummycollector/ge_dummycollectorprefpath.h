...
class GE_DLLIMPORT gCDummyCollectorPrefPath : public gCDummyCollectorPSet_Base
{
    // clang-format off
    ...
    public: ~gCDummyCollectorPrefPath() override;
  ...
  public:
    explicit gCDummyCollectorPrefPath(eCEntity &);
