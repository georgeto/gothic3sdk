...
class GE_DLLIMPORT gCDummyCollectorLinkContainer : public gCDummyCollectorPSet_Base
{
    // clang-format off
    ...
    public: ~gCDummyCollectorLinkContainer() override;
  ...
  public:
    explicit gCDummyCollectorLinkContainer(eCEntity &);
