...
class GE_DLLIMPORT gCDummyCollectorDynamicCollisionCircle : public gCDummyCollectorPSet_Base
{
    // clang-format off
    ...
    public: ~gCDummyCollectorDynamicCollisionCircle() override;
  ...
  public:
    explicit gCDummyCollectorDynamicCollisionCircle(eCEntity &);
