...
class GE_DLLIMPORT gCDummyCollectorEnclave : public gCDummyCollectorPSet_Base
{
    // clang-format off
    ...
    public: ~gCDummyCollectorEnclave() override;
  ...
  public:
    explicit gCDummyCollectorEnclave(eCEntity &);
