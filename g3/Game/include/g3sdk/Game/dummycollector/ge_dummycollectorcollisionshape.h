...
class GE_DLLIMPORT gCDummyCollectorCollisionShape : public gCDummyCollectorPSet_Base
{
    // clang-format off
    ...
    public: ~gCDummyCollectorCollisionShape() override;
  ...
  public:
    explicit gCDummyCollectorCollisionShape(eCEntity &);
