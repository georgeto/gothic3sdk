...
class GE_DLLIMPORT gCDummyCollectorAnchor : public gCDummyCollectorPSet_Base
{
    // clang-format off
    ...
    public: ~gCDummyCollectorAnchor() override;
  ...
  public:
    explicit gCDummyCollectorAnchor(eCEntity &);
